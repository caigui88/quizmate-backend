...
-- 算法题目表初始数据
INSERT INTO `question_code`
(id, userId, title, content, tags, answer, judgeCase, judgeConfig, submitNum, acceptedNum, thumbNum, favourNum,
 createTime, updateTime, isDelete)
VALUES ('1734735574025236481', '1731620803078791170', '模拟栈',
        '实现一个栈，栈初始为空，支持四种操作：\n\npush x – 向栈顶插入一个数 x\n；\n\npop – 从栈顶弹出一个数；\n\nempty – 判断栈是否为空；\n\nquery – 查询栈顶元素。\n\n现在要对栈进行 M\n 个操作，其中的每个操作 3\n 和操作 4\n 都要输出相应的结果。',
        '[\"栈\",\"中等\",\"算法\"]',
        '```java\nimport java.util.*;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int m = sc.nextInt();\n\n        Stack<Integer> stk = new Stack<>();\n\n        while (m -- > 0) {\n            String op = sc.next();\n            if (\"push\".equals(op)) {\n                int x = sc.nextInt();\n                stk.push(x);\n            } else if (\"pop\".equals(op)) {\n                stk.pop();\n            } else if (\"empty\".equals(op)) {\n                if (stk.empty())\n                    System.out.println(\"YES\");\n                else\n                    System.out.println(\"NO\");\n            } else {\n                System.out.println(stk.peek());\n            }\n        }\n    }\n}\n```',
        '[{\"input\":\"10 push 5 query push 6 pop query pop empty push 4 query empty\",\"output\":\"5 5 YES 4 NO\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 08:42:45',
        '2023-12-13 08:42:45', '0'),
       ('1734736264302817281', '1731620803078791170', '斐波那契数列',
        '输入整数 N\n，求出斐波那契数列中的第 N\n 项是多少。\n\n斐波那契数列的第 0\n 项是 0\n，第 1\n 项是 1\n，从第 2\n 项开始的每一项都等于前两项之和。\n\n输入格式\n第一行包含整数 T\n，表示共有 T\n 个测试数据。\n\n接下来 T\n 行，每行包含一个整数 N\n。\n\n输出格式\n每个测试数据输出一个结果，每个结果占一行，\n\n结果格式为 Fib(N) = x，其中 N\n 为项数，x\n 为第 N\n 项的值。\n\n数据范围\n0≤N≤60',
        '[\"数组\",\"简单\",\"算法\",\"贪心\"]',
        '```java\nimport java.util.Scanner;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        long[] f = new long[61];\n        f[0] = 0;\n        f[1] = 1;\n        for (int i = 2; i <= 60; i ++ )\n            f[i] = f[i - 1] + f[i - 2];\n\n        int T = sc.nextInt();\n        while (T -- > 0) {\n            int n = sc.nextInt();\n            System.out.printf(\"Fib(%d) = %d\\n\", n, f[n]);\n        }\n    }\n}\n```',
        '[{\"input\":\"3 0 4 2\",\"output\":\"Fib(0) \\u003d 0 Fib(4) \\u003d 3 Fib(2) \\u003d 1\"}]',
        '{\"timeLimit\":1002,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 08:45:29',
        '2023-12-13 08:45:29', '0'),
       ('1734736737516777473', '1731620803078791170', 'A+B',
        '输入两个整数，求这两个整数的和是多少。\n\n输入格式\n输入两个整数A,B\n，用空格隔开\n\n输出格式\n输出一个整数，表示这两个数的和\n\n数据范围\n0≤A,B≤108',
        '[\"简单\",\"模拟\"]',
        '```java\nimport java.util.Scanner;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int x = sc.nextInt(), y = sc.nextInt();\n        System.out.println(x + y);\n    }\n}\n```',
        '[{\"input\":\"3 4\",\"output\":\"7\"}]', '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '6',
        '5', '0', '0', '2023-12-13 08:47:22', '2023-12-13 08:47:22', '0'),
       ('1734737227533119489', '1731620803078791170', '差',
        '读取四个整数 A,B,C,D\n，并计算 (A×B−C×D)\n 的值。\n\n输入格式\n输入共四行，第一行包含整数 A\n，第二行包含整数 B\n，第三行包含整数 C\n，第四行包含整数 D\n。\n\n输出格式\n输出格式为 DIFERENCA = X，其中 X\n 为 (A×B−C×D)\n 的结果。\n\n数据范围\n−10000≤A,B,C,D≤10000',
        '[\"顺序结构\",\"简单\"]',
        '```java\nimport java.util.Scanner;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int a = sc.nextInt(), b = sc.nextInt();\n        int c = sc.nextInt(), d = sc.nextInt();\n        System.out.printf(\"DIFERENCA = %d\\n\", a * b - c * d);\n    }\n}\n```',
        '[{\"input\":\"5 6 7 8\",\"output\":\"DIFERENCA \\u003d -26\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 08:49:19',
        '2023-12-13 08:52:06', '0'),
       ('1734737675463815170', '1731620803078791170', '圆的面积',
        '计算圆的面积的公式定义为 A=πR2\n。\n\n请利用这个公式计算所给圆的面积。\n\nπ\n 的取值为 3.14159\n。\n\n输入格式\n输入包含一个浮点数，为圆的半径 R\n。\n\n输出格式\n输出格式为 A=X，其中 X\n 为圆的面积，用浮点数表示，保留四位小数。\n\n数据范围\n0<R<10000.00',
        '[\"简单\",\"顺序结构\"]',
        '```java\nimport java.util.Scanner;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        double r = sc.nextDouble();\n\n        System.out.printf(\"A=%.4f\\n\", r * r * 3.14159);\n    }\n}\n```',
        '[{\"input\":\"2.00\",\"output\":\"A\\u003d12.5664\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 08:51:06',
        '2023-12-13 08:51:06', '0'),
       ('1734760170141118466', '1731620803078791170', '用户分组',
        ...
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 10:20:29',
        '2023-12-13 10:20:29', '0'),
       ('1734760786108215297', '1731620803078791170', '最大公约数',
        '输入两个整数 a\n 和 b\n，请你编写一个函数，int gcd(int a, int b), 计算并输出 a\n 和 b\n 的最大公约数。\n\n输入格式\n共一行，包含两个整数 a\n 和 b\n。\n\n输出格式\n共一行，包含一个整数，表示 a\n 和 b\n 的最大公约数。\n\n数据范围\n1≤a,b≤1000',
        '[\"基础\",\"简单\",\"函数\"]',
        '\n```java\nimport java.util.Scanner;\n\npublic class Main {\n    private static int gcd(int a, int b) {\n        for (int i = 1000; i > 0; i -- )\n            if (a % i == 0 && b % i == 0)\n                return i;\n        return 0;\n    }\n\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int a = sc.nextInt(), b = sc.nextInt();\n        System.out.println(gcd(a, b));\n    }\n}\n```',
        '[{\"input\":\"12 16\",\"output\":\"4\"}]', '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}',
        '0', '0', '0', '0', '2023-12-13 10:22:56', '2023-12-13 10:22:56', '0'),
       ('1734761295196057601', '1731620803078791170', '两个数的和',
        '输入两个浮点数 x\n 和 y\n，请你编写一个函数，double add(double x, double y)，计算并输出 x\n 与 y\n 的和。\n\n输入格式\n共一行，包含两个浮点数 x\n 和 y\n。\n\n输出格式\n共一行，包含一个浮点数，表示两个数的和，结果保留 2\n 位小数。\n\n数据范围\n−1000≤x,y≤1000',
        '[\"简单\",\"函数\"]',
        '\n```java\nimport java.util.Scanner;\n\npublic class Main {\n    private static double add(double x, double y) {\n        return x + y;\n    }\n\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        System.out.printf(\"%.2f\\n\", add(sc.nextDouble(), sc.nextDouble()));\n    }\n}\n```',
        '[{\"input\":\"1.11 2.22\",\"output\":\"3.33\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 10:24:57',
        '2023-12-13 10:24:57', '0'),
       ('1734761637199605761', '1731620803078791170', '最小公倍数',
        '输入两个整数 a\n 和 b\n，请你编写一个函数，int lcm(int a, int b)，计算并输出 a\n 和 b\n 的最小公倍数。\n\n输入格式\n共一行，包含两个整数 a\n 和 b\n。\n\n输出格式\n共一行，包含一个整数，表示 a\n 和 b\n 的最小公倍数。\n\n数据范围\n1≤a,b≤1000',
        '[\"简单\",\"基础\",\"函数\"]',
        '\n```\nimport java.util.Scanner;\n\npublic class Main {\n    private static int lcm(int a, int b) {\n        for (int i = 1; i <= a * b; i ++ )\n            if (i % a == 0 && i % b == 0)\n                return i;\n        return -1;\n    }\n\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        System.out.println(lcm(sc.nextInt(), sc.nextInt()));\n    }\n}\n```',
        '[{\"input\":\"6 8\",\"output\":\"24\"}]', '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0',
        '0', '0', '0', '2023-12-13 10:26:19', '2023-12-13 10:26:19', '0'),
       ('1734762018646388738', '1731620803078791170', '数组翻转',
        ...
        '[{\"input\":\"5 3 1 2 3 4 5\",\"output\":\"3 2 1 4 5\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 10:27:50',
        '2023-12-13 10:27:50', '0'),
       ('1734770960977956865', '1731620803078791170', '模拟队列',
        '实现一个队列，队列初始为空，支持四种操作：\n\npush x – 向队尾插入一个数 x\n；\npop – 从队头弹出一个数；\nempty – 判断队列是否为空；\nquery – 查询队头元素。\n现在要对队列进行 M\n 个操作，其中的每个操作 3\n 和操作 4\n 都要输出相应的结果。\n\n输入格式\n第一行包含整数 M\n，表示操作次数。\n\n接下来 M\n 行，每行包含一个操作命令，操作命令为 push x，pop，empty，query 中的一种。\n\n输出格式\n对于每个 empty 和 query 操作都要输出一个查询结果，每个结果占一行。\n\n其中，empty 操作的查询结果为 YES 或 NO，query 操作的查询结果为一个整数，表示队头元素的值。\n\n数据范围\n1≤M≤100000\n,\n1≤x≤109\n,\n所有操作保证合法。',
        '[\"中等\",\"队列\"]',
        '```\nimport java.util.*;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int m = sc.nextInt();\n\n        Queue<Integer> q = new LinkedList<>();\n        while (m -- > 0) {\n            String op = sc.next();\n            if (op.equals(\"push\")) {\n                int x = sc.nextInt();\n                q.add(x);\n            } else if (op.equals(\"pop\")) {\n                q.remove();\n            } else if (op.equals(\"empty\")) {\n                if (q.isEmpty()) {\n                    System.out.println(\"YES\");\n                } else {\n                    System.out.println(\"NO\");\n                }\n            } else {\n                System.out.println(q.peek());\n            }\n        }\n    }\n}\n```',
        '[{\"input\":\"10 push 6 empty query pop empty push 3 push 4 pop query push 6\",\"output\":\"NO 6 YES 4\"}]',
        '{\"timeLimit\":1000,\"memoryLimit\":1000,\"stackLimit\":1000}', '0', '0', '0', '0', '2023-12-13 11:03:22',
        '2023-12-13 11:03:22', '0');


-- 插入模拟帖子数据
INSERT INTO post (id, title, content, tags, thumbNum, favourNum, userId, createTime)
VALUES (1, '初学Java有什么好的学习路径？', '最近开始学习Java编程，想知道有什么推荐的学习路径和资源？谢谢大家！',
        '[\"Java\", \"编程学习\", \"新手\"]', 13, 5, 1001, NOW() - INTERVAL 30 DAY),
       (2, 'Spring Boot项目实战分享', '分享一个我最近做的Spring Boot项目，包含完整的CRUD功能和权限管理系统...',
        '[\"Spring Boot\", \"项目实战\", \"后端\"]', 42, 18, 1002, NOW() - INTERVAL 25 DAY),
       (3, '前端框架对比：React vs Vue', '本文将对比当前最流行的两个前端框架React和Vue的优缺点及适用场景...',
        '[\"前端\", \"React\", \"Vue\"]', 56, 30, 1003, NOW() - INTERVAL 20 DAY),
       (4, 'MySQL性能优化技巧总结', '经过多年的MySQL使用经验，我总结了一些实用的性能优化技巧，包括索引设计、查询优化等...',
        '[\"MySQL\", \"数据库\", \"性能优化\"]', 78, 45, 1004, NOW() - INTERVAL 15 DAY),
       (5, '微服务架构设计实践', '本文分享我们团队在微服务架构设计和实施过程中的经验和教训...',
        '[\"微服务\", \"架构设计\", \"分布式系统\"]', 65, 37, 1002, NOW() - INTERVAL 10 DAY),
       (6, 'Docker入门到精通', 'Docker容器化技术已经成为现代开发不可或缺的一部分，本文将带你从入门到精通...',
        '[\"Docker\", \"容器化\", \"DevOps\"]', 49, 28, 1005, NOW() - INTERVAL 8 DAY),
       (7, '算法学习笔记：动态规划', '动态规划是解决复杂问题的强大工具，本文记录了我学习和应用动态规划的心得...',
        '[\"算法\", \"动态规划\", \"编程技巧\"]', 37, 22, 1006, NOW() - INTERVAL 5 DAY),
       (8, 'Python数据分析实战', '使用Python进行数据分析的完整实战案例，包括数据清洗、可视化和建模...',
        '[\"Python\", \"数据分析\", \"机器学习\"]', 51, 33, 1007, NOW() - INTERVAL 3 DAY);

-- 插入模拟点赞数据
INSERT INTO post_thumb (postId, userId, createTime)
VALUES (1, 1002, NOW() - INTERVAL 29 DAY),
...
-- 插入模拟收藏数据
INSERT INTO post_favour (postId, userId, createTime)
VALUES (1, 1002, NOW() - INTERVAL 28 DAY),
...
-- 插入评论表测试数据
INSERT INTO post_comment (postId, userId, content, parentId, rootId, replyUserId, thumbNum, replyCount, heat, level,
                          status)
VALUES
-- 一级评论
...
-- 插入评论点赞表测试数据
INSERT INTO comment_thumb (commentId, userId)
VALUES
-- 对一级评论的点赞
(1, 102),
(1, 103),
